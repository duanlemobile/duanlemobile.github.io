	...
	<div class="top-nav group">
        <section>
            ...
            <ul class="top-nav-quicklink flexContain">
                ...
                <li><a href="tintuc.html"><i class="fa fa-newspaper-o"></i> NEWS</a ></li>
                <li><a href="tuyendung.html"><i class="fa fa-handshake-o"></i> Recruitment</a></li>
                <li><a href="gioithieu.html"><i class="fa fa-info-circle"></i> About Us</a></li>
                <li><a href="trungtambaohanh.html"><i class="fa fa-wrench"></i> Service Center</a></li>
                <li><a href="lienhe.html"><i class="fa fa-phone"></i> Contacts</a></li>
            </ul> <!-- End Quick link -->
        </section><!-- End Section -->
    </div><!-- End Top Nav  -->`);
}
...
function addFooter() {
  document.write(`
    ...
    <div class="copy-right">
        <p><a href="index.html">DUAN LE MOBILE</a> - All rights reserved © 2021 - Designed by
